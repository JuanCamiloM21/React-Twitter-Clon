...
export const Logo = ({ fillColor = 'white', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Home = ({ fillColor = 'white', width = '26.25' }) => {
  return (
    <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
      <g>
...
export const Hashtag = ({ fillColor = 'white', width = '26.25' }) => {
  return (
...
export const Search = ({ fillColor = 'white', width = '26.25' }) => {
  return (
...
export const Bell = ({ fillColor = 'white', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Send = ({ fillColor = 'white', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Tags = ({ fillColor = 'white', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Book = ({ fillColor = 'white', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Profile = ({ fillColor = 'white', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Settings = ({ fillColor = 'white', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Button = ({ fillColor = 'white', width = '22.5' }) => {
  return (
...
export const Discover = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Gallery = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Gif = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Staticst = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Emoji = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Calendar = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Comment = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const ReTweet = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Like = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
...
export const Share = ({ fillColor = '#1da1f2', width = '26.25' }) => {
  return (
    <div>
      <svg viewBox='0 0 24 24' fill={fillColor} width={width}>
        <g>
